...
export default function Login() {
  ...
  function submit(event: FormEvent) { event.preventDefault(); try { login(email, password); router.push("/dashboard"); } catch (reason) { setError(reason instanceof Error ? reason.message : "No se pudo iniciar sesión."); } }
